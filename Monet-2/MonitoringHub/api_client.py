...
from MonitoringHub.api_response import ApiResponse, T as ApiResponseT
import MonitoringHub.models
from MonitoringHub import rest
from MonitoringHub.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(MonitoringHub.models, klass)
