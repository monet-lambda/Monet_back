...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://monitoringhub.lbdaq.cern.ch/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("MonitoringHub")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://monitoringhub.lbdaq.cern.ch/v1",
                'description': "Monitoring hub server",
            }
        ]
